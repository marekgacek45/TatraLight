    ...
    <div class="max-w-screen-xl mx-auto ">
        <div
            ...
            <div class="lg:w-1/2 m-4 sm:m-6 lg:border-4 border-secondaryColor  overflow-hidden box-shadow--img">
                <img src="https://th.bing.com/th/id/OIG..FPvcxcRHtUt4uLygAhs?pid=ImgGn" alt=""
                    class="w-full h-[400px] lg:h-[560px] object-cover" loading="lazy">
            </div>
            <div
                class="lg:absolute  lg:w-1/2 lg:top-1/2 lg:right-10 lg:transform lg:-translate-y-1/2 w-full md:px-6 md:mb-12 lg:mb-0 lg:p-6 bgi bgi--one bg-overlayColor bg-blend-multiply z-10 box-shadow--img2">
